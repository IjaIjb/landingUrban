...
export default function RegisterDialog({ isOpen, setisopen }: PropT) {
  ...
  const handleFleet = () => {
    router.push("/register/fleet");
    setisopen(!open)
  };

  const handlePark = () => {
    router.push("/register/park");
    setisopen(!open)
  };
          ...
          <div className="mt-6 px-10 2xl:mt-14 flex flex-col gap-y-8">
            <div className="w-full flex flex-col justify-center items-center gap-y-2">
              ...
              {/* <Link href="https://urban.ng" target="_blank"> */}
                <button 
                    onClick={() => {
                      window.location.href = "https://fleet.urban.ng/register"; // Replace with your actual URL
                    }}
                    className="text-sm underline bg-[#6cc56c39] py-1 px-4 rounded-md font-light">
                  fleet.urban.ng/register
                </button>
              {/* </Link> */}
            </div>
            ...
            <div className="w-full flex flex-col justify-center items-center gap-y-2">
              ...
              {/* <Link href="https://urban.ng" target="_blank"> */}
                <button
                  onClick={() => {
                    window.location.href = "https://agency.urban.ng/register"; // Replace with your actual URL
                  }}
                   className="text-sm underline bg-[#6cc56c39] py-1 px-4 rounded-md font-light">
                  agency.urban.ng/register
                </button>
              {/* </Link> */}
            </div>
          </div>
