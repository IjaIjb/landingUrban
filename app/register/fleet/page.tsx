...
import "./registerFleet.scss";
// import { addIndividual } from '@/app/service/api';
      ...
      <div className="grid lg:grid-cols-2 items-center gap-14 w-full h-full ">
        ...
        <div className="w-full z-10 h-screen lg:block hidden relative">
          <div className="absolute h-screen z-10 object-cover w-full rounded-xl">
            ...
            <Image
              className="h-full z-10 object-cover w-full"
              src="/assets/register/fleetBg.jpg"
                      ...
                      <div className="">
                        ...
                        <div className="grid md:grid-cols-2 gap-3 w-full">
                          <div className=" mb-3 relative">
                            ...
                            <Field
                              className="mt-1 block w-full h-7 border-[0.5px]  pl-3 rounded-[10px] focus:outline-none border-[#D9D9D9] "
                              name="phone"
                              type="text"
                              id="phone"
                              placeholder=""
...
Congratulations, your registration is successful. Our team will contact you shortly.
            </h4>
            </div>
